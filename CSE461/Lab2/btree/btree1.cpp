...
int main() 
{
    ...
    string s1 = "C G J X";
    string s2 = "C G J X N S U O A E B H I";
    string s3 = "C G J X N S U O A E B H I F";
    string s4 = "C G J X N S U O A E B H I F K L Q R T V U W Z";
  
    vector<string> v = seperateString(s1);
    vector<string> v1 = seperateString(s2);
    vector<string> v2 = seperateString(s3);
    vector<string> v3 = seperateString(s4);
